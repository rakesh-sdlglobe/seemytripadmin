...
import TrainSvg from "../../../images/train-svgrepo-com.svg";
                ...
                <div className="col-xl-3 col-sm-6">
                  <div className="card booking">
                    <div className="card-body">
                      <div className="booking-status d-flex align-items-center">
                        <span>
                          <img src={TrainSvg} style={{ width: "40px" }} />
                        </span>
                        <div className="ms-4">
                          <h2 className="mb-0 font-w600">753</h2>
                          <p className="mb-0">Active Trains</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="card-body">
                      <div className="booking-status d-flex align-items-center">
                        ...
                        <div className="ms-4">
                          ...
                          <p className="mb-0">Delayed Trains</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="col-xl-12 col-lg-12 col-xxl-12 col-sm-12">
              <div className="card">
                <div className="card-header">
                  <h4 className="card-title">Train Schedule for Today</h4>
                </div>
                <div className="card-body">
                  <div className="table-responsive trainScheduleTable">
